    ...
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-6">
        ...
        <button 
          ...
          className="flex items-center gap-3 hover:bg-slate-50 p-1 pr-3 rounded-xl transition-colors group"
        >
          <div className="text-right hidden sm:block">
            <p className="text-sm font-semibold text-slate-900 leading-none group-hover:text-blue-600 transition-colors">Dept. Admin</p>
